...
def user_dash(request):
    ...
    user_info = User.objects.get('user_id')
...
def create_task(request):
    ...
    return render(request, 'willto_list.html')

def new_task(request):
    return render(request, 'new_task.html')

def willto_list(request):
    return render(request,'willto_list.html')
...
def all_tasks_rank_list(request):
    context = {
        "all_tasks": Task.objects.all()
    }
    return render(request,'all_tasks_rank_list.html', context)
